      ...
      helpers.stubUtxos(server, wallet, [1, 1], function() {
        ...
        helpers.createAndPublishTx(server, txOpts, TestData.copayers[0].privKey_1H_0, function(tx) {
          setTimeout(function() {
            ...
            var one = emails[0];
            one.from.should.equal('bccws@dummy.net');
        ...
        server.txConfirmationSubscribe({
          ...
          server._notify('TxConfirmation', {
            ...
            setTimeout(function() {
              ...
              email.from.should.equal('bccws@dummy.net');
        ...
        server.createAddress({}, function(err, address) {
          ...
          server._notify('NewIncomingTx', {
            ...
            setTimeout(function() {
              ...
              spanish.from.should.equal('bccws@dummy.net');
              spanish.subject.should.contain('Nuevo pago recibido');
              spanish.text.should.contain('0.123 BCC');
              var english = _.find(emails, {
                to: 'copayer2@domain.com'
              });
              english.from.should.equal('bccws@dummy.net');
